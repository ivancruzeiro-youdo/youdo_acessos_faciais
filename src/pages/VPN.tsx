...
function useVpnAction<T = any>(action: string, params?: Record<string, any>) {
  ...
  const pathMap: Record<string, string> = {
    ...
    list_certificates: "/vpn/certificates",
    vpn_logs: "/vpn/logs",
  };
...
function Certificates() {
  ...
  const create = useMutation({
    ...
    mutationFn: async () => api.post("/vpn/certificates", {
  ...
  const revoke = useMutation({
    ...
    mutationFn: async (id: string) => api.post(`/vpn/certificates/${id}/revoke`, { reason: "Revogado pelo painel" }),
  ...
  const downloadCert = async (id: string, name: string) => {
    ...
    try {
      ...
      const data = await api.get<any>(`/vpn/certificates/${id}/download`);
